...
Команда, позволяющая склонировать внешний репозиторий на ваш ПК:

    git clone <link>

После нее вставляется ссылка на репозиторий, например с GitHub'a.

Эта команда позволяет скачать все из текущего репозитория и автоматически сделать merge с нашей версией:

    git pull

Эта команда позволяет отправить нашу версию репозитория на внешний репозиторий. Если команда выполняется вами впервые, то потребуется авторизация на внешнем репозитории.
