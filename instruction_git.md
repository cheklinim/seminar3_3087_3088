...
Клонировать переданный репозиторий на свой компьютер.

    git clone <ссылка на repo>

Получить изменения из переданного удаленного репозитория и обновить рабочую копию в соответствии с удаленным репозиторием.
