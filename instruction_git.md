...
### Сохранить удаленный репозиторий

Для сохранения удаленного репозитория на локальный носитель используют команду:

    git clone <link>

### Отправка изменений в удаленный репозиторий

Для отправки изменений с локального в удаленный репозиторий используют команду:
