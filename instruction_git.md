...
* Открываем на Github наш удаленный репозиторий 
* Выбираем фаил
...
Эта команда позволяет скачать все из репозитория с Github и автоматически сделать merge с 

## Работа с командами fork
1. 
* Для работы с чужим репозиторием переходим по ссылке в Github
* Нажимаем на fork
* Задаем имя файлу
* можем скопировать все ветки или только ветку master
* нажимаем create fork

Создаеся репозиторий, но на вашей странице Github

2. Далее необходимо склонировать этот репозиторий себе на компьютер. Копируем ссылку под кнопкой Code
Используем команду

        git clone <ссылкка на репозиторий>


3. Далее в VSC создаем новую папку. Открываем терминал и вводим команду

        git clone <скопированная ссылка>    

На компьютере появится скопированный чужой реппозиторий из Gikhub


4. Далее необходимо выбрать скопированную папку используя команду

        cd <имя скопированной папки из репозитория Gikhub>

5. Создаем новую ветку и переходим в нее с помощью команд

        git branch <имя новой ветки>

        git checkout <имя новой ветки>        

6. Проверяем статус с помощью команды
    ...
    создаем коммит
        ...
        git coomit -m "имя коммита"

7. Обновляем удаленный репозиторий

        git push

8. Git подсказывает какую команду нужно ввести, чтобы репозиторий ушел на Github

        git push --set-upstream origin <имя ветки>

9. Переходим на сайт Github. Видим изменения, переходим в нашу созданную ветку в репозитории и нажимаем 

10. Владельцу удаленного репозитория с Github прийдет сообщение с запросом о вливании ветки в его репозиторий
