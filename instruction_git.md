...
* Важно: перед началом работы с репозиторием как всегда обязательно нужно выбрать готовую папку либо создать и выбрать новую папку. При этом выполнять команду git init *не нужно*, только создать новый терминал.
...
Если точнее, для начала работы с этим репозиторием в VS Code необходимо сначала привязать удаленный репозиторий через команду
...
Если у вас нет доступа к аккаунту-хозяину репозитория и вы хотите предложить правки, то можете пойти следующим путем:

1. Воспользоваться функцией **Fork** на странице репозитория в GitHub.
2. Таким образом в вашем аккаунте появится копия этого репозитория, которую вы можете клонировать и редактировать по образцу предыдущего пункта.
3. После создания локальной копии этого репозитория обязательно **создайте новую ветку и все правки производите в этой ветке**. *Также хорошим тоном будет создать в рамках этой ветки файл README.md и описать там суть предлагаемых вами изменений*.
4. Все сохранения выполняйте обычным путем ctrl+s, add, commit, но после них обязательно используйте следующую функцию:

    **git push --set-upstream origin <имя ветки>**
5. Это приведет к обновлению репозитория в вашем аккаунте.
6. Появится кнопка **Compare & pull request**, нажав которую вы предложите свои правки хозяину репозитория, а он сможет принять или отклонить их.